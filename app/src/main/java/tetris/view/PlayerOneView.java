...
public class PlayerOneView extends JPanel{
    ...
    private static class LazyHolder {
        private static final PlayerOneView INSTANCE = new PlayerOneView();
    }

    public static PlayerOneView getInstance() {
        return PlayerOneView.LazyHolder.INSTANCE;
    }

    private PlayerOneView() {
