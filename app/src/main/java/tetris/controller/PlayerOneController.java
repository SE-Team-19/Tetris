...
public class PlayerOneController {
    ...
    private void initGameController() {
        ...
        gamePane = battleModeView.getPlayerOneGameBoardPane();
        nextBlockPane = battleModeView.getPlayerOneNextBlockPane();
        attackLinePane = battleModeView.getPlayerOneAttackLinePane();
    ...
    private class InitGameKeyMap {
        ...
        private void initStackKey() {
             ...
             * diffMode = 1;
             * transitView(battleModeView, battleModeView.getGameDisplayPane(),
             * battleModeView.getSelectDiffPane());
             * startGame();
             * });
            ...
            gameKeyMap.put(new KeyPair(stackKey, battleModeView.getGeneralModeBtn()), () -> {
                gameMode = 0;
                transitView(battleModeView, battleModeView.getBattleModeDisplayPane(),
                        battleModeView.getSelectBattleModePane());
                startGame();
            });
    ...
    private void showScore() {
        battleModeView.getPlayerOneScorePane().setText(String.format("%d", score));
    }

    private void showTime() {
        battleModeView.getPlayerOneTimePane().setText(String.format("%d", gameTime));
    }
}